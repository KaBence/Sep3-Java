...
public class SepServiceImplementationTest {
    ...
    public void CreateOrderTest() throws Exception {
        ...
        Mockito.when(orderDao.createOrder(request.getNewOrder(), orderItems, request.getPaymentMethod(), request.getNote()))
                .thenReturn("Success!");
    ...
    void CreateOrderWithoutItems() throws Exception {
        ...
        List<DtoOrderItem> orderItems = new ArrayList<>(request.getOrderItemsList());
        Collections.sort(orderItems, Comparator.comparing(DtoOrderItem::getFarmName));
        Mockito.when(orderDao.createOrder(request.getNewOrder(), orderItems, request.getPaymentMethod(), request.getNote())).thenThrow(new Exception("Error: There are no orderItems"));
    ...
    void CreateOrderWithoutPayment() throws Exception {
        ...
        List<DtoOrderItem> orderItems = new ArrayList<>(request.getOrderItemsList());
        Collections.sort(orderItems, Comparator.comparing(DtoOrderItem::getFarmName));
        Mockito.when(orderDao.createOrder(request.getNewOrder(), orderItems, request.getPaymentMethod(), request.getNote())).thenThrow(new Exception("Error: There is no payment method"));
    ...
    void CreateOrderWithoutOrder() throws Exception {
        ...
        List<DtoOrderItem> orderItems = new ArrayList<>(request.getOrderItemsList());
        Collections.sort(orderItems, Comparator.comparing(DtoOrderItem::getFarmName));
        Mockito.when(orderDao.createOrder(request.getNewOrder(), orderItems, request.getPaymentMethod(), request.getNote())).thenThrow(new Exception("Error: There is no order"));
    ...
    void createProductWithoutProductTest() throws Exception {
        ...
        Mockito.when(productDao.createProduct(request.getNewProduct())).thenThrow(new Exception("Error: There is no product"));
    ...
    void getProductWithoutIdTest() throws Exception {
        ...
        Mockito.when(productDao.getProductById(request.getId())).thenThrow(new Exception("Error: Product with "+ request.getId() +" not found!"));
    ...
    void editProductWithoutProduct() throws Exception {
        ...
        Mockito.when(productDao.editProduct(request.getProduct())).thenThrow(new Exception("Error: There is no product"));
